use crate::{
    datatypes::{claims::UserClaims, response_types::{AppError, AppResponse}},
    generated::protos::settings::profile::confirmation::{
        response, Error, Request,
        Response, Success,
    },
    models::user::User,
    services::{cache_service::CacheService, response_service::ResponseService, token_service::TokenService},
    utils::{
...
pub async fn post_totp(
    ...
    let set_redis_result =
        cache_service.store_key_value(&token, &user_uuid_str, expiry_in_seconds);
