...
|------------------------|--------------|-------------------------------|--------|----------|-------|
| id                     | INT          | Primary key                   | True   | True     | True  |
| device_type            | VARCHAR(20)  | Type of device                | True   | True     | True  |

device_type: mobile, tablet, laptop, pc

## Platform Type
| Field                  | Type         | Description                   | UNIQUE | NOT NULL | INDEX |
|------------------------|--------------|-------------------------------|--------|----------|-------|
| id                     | INT          | Primary key                   | True   | True     | True  |
| platform_type          | VARCHAR(20)  | How the app was accessed      | True   | True     | True  |

platform_type: android, ios, linux, windows, website
...
A device may have multiple accounts
